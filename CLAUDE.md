...
- macOS/Linux: `.claude/statusline-command.sh` — macOS Keychain first, then `~/.claude/.credentials.json`
- Both output 3 lines: model/context/git info, 5h rate limit bar, 7d rate limit bar
